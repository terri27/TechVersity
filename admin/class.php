              ...
              <tbody>
                ...
                foreach ($classes as $class) {
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="class-edit.php?class_id=<?= $class['class_id'] ?>" class="btn btn-warning">Editar</a>
                      <a href="class-delete.php?class_id=<?= $class['class_id'] ?>" class="btn btn-danger">Eliminar</a>
                    </td>
                  </tr>
                <?php } ?>
              </tbody>
